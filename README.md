...
### 👩‍💻 About Me
- 🔧 Experience with **ERP, PDV, Omnisige, Mobili**
- 🛒 E-commerce support using **VTEX**
- 🎫 Incident management with **Deskmanager**
- 📊 Supporting systems that handle **thousands of daily transactions**
- 🌱 Currently transitioning into **Software Development**

---

### 🛠️ Tech & Tools
![ERP](https://img.shields.io/badge/ERP-Systems-blue)
![VTEX](https://img.shields.io/badge/VTEX-Ecommerce-red)
![Deskmanager](https://img.shields.io/badge/Deskmanager-Support-green)
